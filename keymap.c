 ...
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |  Caps  |   A  |   S  |   D  | L1/F |   G  |------|           |------|   H  |   J  | L1/K |   L  |   Ö  |   Ä    |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | LShift |   Z  |   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |   .  |  -   | RShift |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |  L1  |  <|> |      | Alt | LGui  |                                       | Ctrl | Alt  |   '  |      | RCtrl|
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | LEFT |RIGHT |       | DOWN | UP   |
 *                                 ,------+------+------|       |------+--------+------.
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_CAPS,   KC_A,             KC_S,             KC_D,     LT(1, KC_F), KC_G,
        ...
        _______,     KC_Y,   KC_U,        KC_I,        KC_O,     KC_P,        KC_LBRC,
                     KC_H,   LT(1, KC_J), KC_K,        KC_L,     KC_SCLN,     CTL_T(KC_QUOT),
        _______,     KC_N,   KC_M,        KC_COMM,     KC_DOT,   KC_SLSH,     KC_RSFT,
                             KC_LCTRL,    KC_RALT,     KC_BSLS,  _______,     KC_RCTRL,
        KC_DOWN, KC_UP,
        KC_PGUP,
...
[SYMB] = LAYOUT_ergodox(
       ...
       _______, _______, KC_PGUP,  KC_UP,   _______,   _______, _______,
                KC_HOME, KC_LEFT,  KC_DOWN, KC_RIGHT,  KC_END,  _______,
       _______, _______, KC_PGDN,  _______, _______,   _______, _______,
                         _______,  _______, _______,   _______, _______,
       RGB_TOG, RGB_SLD,
       _______,
